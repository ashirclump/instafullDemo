...
const Swipe3 = ({props, route,navigation}) => {
 ...
 matrix={ [1,1,1] } /> 
        ...
        <View style={style.buttons}>
          ...
          onPress= {(image => {  navigation.navigate ("Sample" ,{img : img }); })}
            style={style.but}>
            <Text style={style.butext}>1</Text>
          </TouchableOpacity>

          <TouchableOpacity
            onPress= {(image => {  navigation.navigate ("Sample2" ,{img : img }); })}
            style={style.but}>
            <Text style={style.butext}>2</Text>
          </TouchableOpacity>

          <TouchableOpacity
            // onPress= {(image => {  navigation.navigate ("Swipe3" ,{img : image }); })}
            style={style.but}>
